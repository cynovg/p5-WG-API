[![MetaCPAN Release](https://badge.fury.io/pl/p5-WG-API.svg)](https://metacpan.org/release/p5-WG-API) [![Build Status](https://travis-ci.org/cynovg/p5-WG-API.svg?branch=master)](https://travis-ci.org/cynovg/p5-WG-API) [![Coverage Status](https://img.shields.io/coveralls/cynovg/p5-WG-API/master.svg?style=flat)](https://coveralls.io/r/cynovg/p5-WG-API?branch=master)
# NAME
